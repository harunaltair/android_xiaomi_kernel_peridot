...
#define PINGROUP(id, f1, f2, f3, f4, f5, f6, f7, f8, f9, wake_off, bit, f10, f11)	\
	{					        \
		.name = "gpio" #id,			\
		.pins = gpio##id##_pins,		\
...
static const char * const egpio_groups[] = {
	...
	"gpio133", "gpio134", "gpio135", "gpio136", "gpio137",
	"gpio138", "gpio139", "gpio140", "gpio141", "gpio142",
...
static const struct msm_pingroup neo_groups[] = {
	[0] = PINGROUP(0, qup0_se0, ibi_i3c, jitter_bist, NA, NA, NA, NA, NA,
		       NA, 0x9C014, 0, NA, NA),
	[1] = PINGROUP(1, qup0_se0, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	...
	[8] = PINGROUP(8, qup1_se2, pll_bist, NA, NA, NA, NA, NA, NA, NA,
		       0, -1, NA, NA),
	[9] = PINGROUP(9, qup1_se2, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	...
	[22] = PINGROUP(22, qup0_se4, qup0_se2, aoss_cti, phase_flag20,
			tgu_ch2, NA, NA, NA, NA, 0, -1, NA, NA),
	[23] = PINGROUP(23, qup0_se4, qup0_se2, aoss_cti, phase_flag19,
			tgu_ch3, NA, NA, NA, NA, 0x9C014, 6, NA, NA),
	...
	[39] = PINGROUP(39, qdss_gpio12, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 2, NA, NA),
	[40] = PINGROUP(40, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 1, NA, NA),
	[41] = PINGROUP(41, qup0_se3, mdp_vsync, phase_flag18, NA, ddr_pxi1,
			NA, NA, NA, NA, 0x9C014, 7, NA, NA),
	[42] = PINGROUP(42, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C00C, 3, NA, NA),
	[43] = PINGROUP(43, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 2, NA, NA),
	[44] = PINGROUP(44, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 3, NA, NA),
	[45] = PINGROUP(45, qdss_gpio14, ddr_pxi1, atest_char, NA, NA, NA, NA,
			NA, NA, 0x9C00C, 4, NA, NA),
	...
	[49] = PINGROUP(49, mdp_vsync, mdp_vsync0, mdp_vsync1, NA, NA, NA, NA,
			NA, NA, 0x9C014, 8, NA, NA),
	[50] = PINGROUP(50, mdp_vsync, mdp_vsync2, mdp_vsync3, NA, NA, NA, NA,
			NA, NA, 0x9C014, 9, NA, NA),
	[51] = PINGROUP(51, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	[52] = PINGROUP(52, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	...
	[57] = PINGROUP(57, ddr_pxi0, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 10, NA, NA),
	[58] = PINGROUP(58, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C00C, 11, NA, NA),
	...
	[65] = PINGROUP(65, qdss_gpio0, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C014, 12, NA, NA),
	[66] = PINGROUP(66, qdss_gpio1, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	...
	[98] = PINGROUP(98, qup0_se5, phase_flag6, NA, NA, NA, NA, NA, NA, NA,
			0x9C018, 3, NA, NA),
	[99] = PINGROUP(99, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	[100] = PINGROUP(100, usb0_phy, ddr_bist, NA, NA, NA, NA, NA, NA, NA,
			 0x9C000, 6, NA, NA),
	[101] = PINGROUP(101, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 7, NA, NA),
	[102] = PINGROUP(102, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 8, NA, NA),
	[103] = PINGROUP(103, ext_mclk1, audio_ref, dp0_hot, ddr_bist, NA, NA,
			 NA, NA, NA, 0x9C018, 4, NA, NA),
	...
	[109] = PINGROUP(109, qup1_se3, qdss_gpio, atest_usb01, NA, NA, NA, NA,
			 NA, NA, 0x9C010, 2, NA, NA),
	[110] = PINGROUP(110, qup1_se3, qdss_gpio, atest_usb00, NA, NA, NA, NA,
			 NA, NA, 0, -1, NA, NA),
	[111] = PINGROUP(111, host2wlan_sol, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C000, 9, NA, NA),
	[112] = PINGROUP(112, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 10, NA, NA),
	[113] = PINGROUP(113, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C010, 3, NA, NA),
	[114] = PINGROUP(114, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 11, NA, NA),
	[115] = PINGROUP(115, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 12, NA, NA),
	[116] = PINGROUP(116, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 13, NA, NA),
	[117] = PINGROUP(117, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 14, NA, NA),
	[118] = PINGROUP(118, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 15, NA, NA),
	[119] = PINGROUP(119, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	[120] = PINGROUP(120, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, NA),
	[121] = PINGROUP(121, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 0, NA, NA),
	[122] = PINGROUP(122, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 1, NA, NA),
	[123] = PINGROUP(123, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	[124] = PINGROUP(124, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C018, 10, NA, egpio),
	[125] = PINGROUP(125, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	...
	[128] = PINGROUP(128, phase_flag1, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1, NA, egpio),
	[129] = PINGROUP(129, gcc_gp1, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	[130] = PINGROUP(130, gcc_gp2, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	[131] = PINGROUP(131, gcc_gp3, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	...
	[139] = PINGROUP(139, phase_flag13, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C01C, 0, NA, egpio),
	[140] = PINGROUP(140, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 1, NA, egpio),
	[141] = PINGROUP(141, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 2, NA, egpio),
	[142] = PINGROUP(142, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	[143] = PINGROUP(143, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 3, NA, egpio),
	[144] = PINGROUP(144, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 4, NA, egpio),
	[145] = PINGROUP(145, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 5, NA, egpio),
	[146] = PINGROUP(146, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 6, NA, egpio),
	[147] = PINGROUP(147, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	...
	[151] = PINGROUP(151, phase_flag4, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C01C, 9, NA, egpio),
	[152] = PINGROUP(152, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
	[153] = PINGROUP(153, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 10, NA, egpio),
	[154] = PINGROUP(154, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1, NA, egpio),
